  ...
  <div>
    ...
    <div class="mb-[56px] sm:mb-0 sm:mt-[56px]">
      <div class="w-screen overflow-x-hidden flex flex-col bg-zinc-800 text-gray-100 text-sm">
        <div class="flex flex-col items-center py-4 mt-16"><a class="font-semibold text-3xl text-gray-100" href="/">SDXL</a>
          ...
          <div class=" mb-8 flex flex-col items-center">
            <div class="flex space-x-2">
              <button @click="sendRequest" class="w-32 sm:w-36 flex items-center text-xs justify-center text-center  h-9 rounded-full  hover:brightness-110 bg-opacity-0 shadow-sm  mt-4 bg-gradient-to-t from-indigo-900 via-indigo-900 to-indigo-800">Search</button>
              <a href="/aperture">
                <button class="w-32 sm:w-36 flex items-center text-xs justify-center text-center  h-9 rounded-full  hover:brightness-110 bg-opacity-0 shadow-sm  mt-4 border border-gray-700 hover:bg-zinc-700">Generate</button>
              </a>
            </div>
          </div>
          <div class="mt-2"> </div>
    ...
    <div w-full mt-4 px-1 relative>
      <div role="grid" class="active:outline-none focus:outline-none" tabindex="0" style="position: relative; width: 100%; max-width: 100%; height: 6053px; max-height: 6053px;">
