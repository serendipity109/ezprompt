    ...
    <div>
        <div role="dialog" id="radix-:r0:" aria-describedby="radix-:r2:" aria-labelledby="radix-:r1:" data-state="open"
            ...
            <div class="flex flex-col text-zinc-200 text-center items-center">
                ...
                <form><input autocomplete="email" placeholder="Email address"
                        class="w-64 px-3 py-2 bg-zinc-700 focus:outline-none focus:ring-1 focus:ring-indigo-600 rounded-lg border border-zinc-600 hover:brightness-110"
                        type="email" value=""><button type="submit"
                        class="hover:brightness-110 bg-gradient-to-t from-indigo-800 via-indigo-800 to-indigo-700 border border-indigo-800 px-4 py-1.5 rounded-lg shadow h-9 w-64 drop-shadow flex items-center justify-center mt-3">Continue</button>
                </form>
        </div>
    </div>
</template>
